            ...
            add: function(user, login) {
                return $q(function(resolve, reject) {
                    if (user.email && user.password) {
                        ...
                        authServiceError.message = "email & password fields are required in order to create user!";
                        reject(authServiceError);
                    }
                });
            ...
            login: function(user) {
                return $q(function(resolve, reject) {
                    if (user.email && user.password) {
                        ...
                        authServiceError.message = "email & password fields are required to login user!";
                        reject(authServiceError);
                    }
                });
            },
            ...
            resetPassword: function(user) {
                return $q(function(resolve, reject) {
                    if (user.email) {
                        ...
                        authServiceError.message = "email field is required to reset password!";
                        reject(authServiceError);
                    }
                });
            },
